...
function drawCoverPage(doc, products, categories, settings) {
  ...
  if (settings.whatsapp_number) {
    ...
    iconChat(doc, iconX, rowY - 1, iconSize, TEXT_DARK);
    doc
      .fillColor(TEXT_DARK)
      .font("Helvetica-Bold")
      .fontSize(12)
      .text(`WhatsApp: ${formatWhatsappDisplay(settings.whatsapp_number)}`, textX, rowY + 1, { width: textW });
    rowY += 27;
  }
  ...
  if (settings.instagram_handle) {
    ...
    iconInstagram(doc, iconX, rowY - 1, iconSize, TEXT_DARK);
    doc
      .fillColor(TEXT_DARK)
      .font("Helvetica-Bold")
      .fontSize(12)
      .text(`Instagram: ${settings.instagram_handle}`, textX, rowY + 1, { width: textW });
    rowY += 27;
  }
